...
5. 解决Win7 A5蓝屏问题(仅64位)：替换C:\Windows\System32\drivers\acpi.sys文件。
6. 扩展更新版默认集成USB3.0。

#### ★ 系统特色：
- 采用Windows 7 SP1 简体中文旗舰版+VL专业版+企业版制作，无精简。
- 常规版IE浏览器为IE8/11；扩展更新版IE浏览器仅IE11；没有锁定主页，主页可以自由更改。
- 常规版补丁升级至2020年1月14日；扩展更新版补丁升级至2023年1月10日。
- 通过正版验证，支持Windows Update在线更新。
☆(如遇极少部分机器开启AHCI蓝屏，推荐修改为IDE模式再安装)
- 关于激活：默认不激活系统。
- 集成VC++ 2005/2008/2010/2012/2013/2022运行库。
- 集成DirectX 9.0c 运行库。
- 集成Microsoft .NET Framework 4.8 正式版。
- 集成Microsoft Edge v109.0.1518.140。
- 集成WinRAR v7.00 简体中文版。
- 集成驱动总裁2.16.0.0万能网卡版/离线版(标准版)，再配合驱动总裁在线版，补全所有驱动。
- 桌面图标显示：用户文档、计算机、网络、回收站、Internet Explorer。
- 修改任务栏上库打开为计算机。
- 开始菜单中显示“运行”
- 关闭操作中心。
- 禁止休眠。
...
- 去掉右键不常用新建菜单。
- 右键添加“用记事本打开”
- 文件属性添加HashTab校验功能(可检测MD5、SHA-1等)。
- 添加政府公文必备字体：仿宋_GB2312，楷体_GB2312，方正小标宋简体。
- 开启无线服务。
- 默认Administrator帐户登录，密码为空。
...
- ㈠常规版：补丁升级至2020年1月14日，部署中安装VC、DX9、进入桌面才安装.NET4.8，IE浏览器为IE8/11可选。
...
- ㈡扩展更新版：补丁升级至2023年1月10日，离线整合VC、DX9、.NET4.8，IE浏览器仅IE11。
